...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> ouncheUomOptional = unitOfMeasureRepository.findByUom("Ounche");
        if(!ouncheUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found! 7");
        }
        ...
        UnitOfMeasure ounche = ouncheUomOptional.get();

        // get CategoriesOptional
        ...
        guacRecipe.setSource("any source");
